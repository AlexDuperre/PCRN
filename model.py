...
class ResBlock(nn.Module):
    def __init__(self, ResLayer):
        ...
        # Layer 2
        self.conv1 = nn.Conv2d(3, 9, kernel_size=5, stride=1, padding=2)
        self.activ1 = nn.Tanh()# GaussActivation() #nn.ReLU()
        ...
        self.activ2 = nn.Tanh() #GaussActivation() #nn.ReLU()
        self.batchNorm2 = nn.BatchNorm2d(18)
        self.maxPool2 = nn.MaxPool2d(kernel_size=2, stride=2)

        # Layer 3
        self.conv3 = nn.Conv2d(18, 21, kernel_size=5, stride=1, padding=2)
        self.conv3_drop = nn.Dropout2d()
        self.activ3 = nn.Tanh() #GaussActivation()# nn.ReLU()
        self.batchNorm3 = nn.BatchNorm2d(21)
...
def PCRN(batch, width, height, num_classes= 55):
    ...
    modelFeatures.pop(0)
    first_conv_layer = [nn.Conv2d(63, 64, kernel_size=7, stride=2, padding=3, dilation=1, groups=1, bias=False)]
...
class GaussActivation(nn.Module):
    ...
    def __init__(self, mean=0, std=0.1, min=-0.1, max=0.1):
